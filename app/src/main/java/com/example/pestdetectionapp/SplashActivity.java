        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(isNetworkConnected()) {
                    ...
                    processdata(); // Download the pest info
        ...
        call.enqueue(new Callback<List<mydata>>() {
            ...
            public void onResponse(Call<List<mydata>> call, Response<List<mydata>> response) {
                ...
                for (mydata item : data) {
                    ...
                    System.out.println("SPLASH DATA: " +data);
                    System.out.println("SPLASH ITEM: " +item);
                    Glide.with(getApplication()).asBitmap().load(ImageUrl).into(new CustomTarget<Bitmap>() {
                        ...
                        public void onResourceReady(@NonNull Bitmap bitmap, @Nullable Transition<? super Bitmap> transition) {
                            ...
                            if (db.checkpest_id(Integer.parseInt(Id))) {
                                ...
                                Log.d("PEST", "PEST ALREADY EXISTED");
                            }
                        }
            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        Toast.makeText(SplashActivity.this,"Can't provide Location. No internet connection.",Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
